...
```bash
git clone https://github.com/Ariesjeev/CreditWise_Loan_System.git
cd CreditWise_Loan_System
```
### 2. Run the Jupyter Notebook

Open [credit_wise.ipynb](credit_wise.ipynb) in your IDE of choice (such as VS Code or Jupyter Lab) and execute the cells.
